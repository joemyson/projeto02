...
class ListaVenda extends StatefulWidget {
  @override
  _ListaVendaState createState() => _ListaVendaState();
}

class _ListaVendaState extends State<ListaVenda> {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          Navigator.push(
              context, MaterialPageRoute(builder: (context) => Venda()));
        },
        tooltip: 'add note',
